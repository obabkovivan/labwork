package org.example.labwork8.examples;
...
public class Example1 {
    public static void main(String[] args) {
        try {
            ...
            title1.appendChild(doc.createTextNode("Буона меп"));
            ...
            title2.appendChild(doc.createTextNode("Настоящая и Марипетра"));
            ...
            javax.xml.transform.Result result = new StreamResult(new File("src/main/java/org/example/labwork8/files/example.xml"));
